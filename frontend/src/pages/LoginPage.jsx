...
export default function LoginPage() {
    // Add at top of LoginPage component temporarily
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                    ...
                    <p className="text-gray-400 text-sm text-center mb-8">
                        Sign in to continue to SyncStream
                    </p>
                    ...
                    <button 
                        ...
                        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50
                                   text-gray-800 font-medium py-3 px-4 rounded-xl transition-all duration-200
                    ...
                    <p className="mt-6 text-gray-500 text-xs text-center">
                        By sigining in, you agree to our Terms of Service and Privacy Policy.
                    </p>
                </div>
            </div>
        </div>
